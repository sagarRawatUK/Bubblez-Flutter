          ...
          child: Row(
            ...
            children: [
              GestureDetector(
                ...
                child: Container(
                  child: Icon(EvaIcons.emailOutline, color: yellowColor),
                  width: 80.0,
                  height: 40.0,
                  decoration: BoxDecoration(
              ...
              GestureDetector(
                ...
                child: Container(
                  child: Icon(FontAwesomeIcons.google, color: redColor),
                  width: 80.0,
                  height: 40.0,
                  decoration: BoxDecoration(
              ...
              GestureDetector(
                child: Container(
                  child: Icon(FontAwesomeIcons.facebookF, color: blueColor),
                  width: 80.0,
                  height: 40.0,
                  decoration: BoxDecoration(
